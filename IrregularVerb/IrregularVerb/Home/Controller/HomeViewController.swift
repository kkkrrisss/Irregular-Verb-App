...
class HomeViewController: UIViewController {
    ...
    //selector - значит должно быть совместимо с obj-c
    @objc
    ...
    private func setupConstraints() {
        ...
        firstButton.heightAnchor.constraint(equalToConstant: buttonHeight).isActive = true //высота кнопки
        ...
        secondButton.heightAnchor.constraint(equalToConstant: buttonHeight).isActive = true //высота кнопки
